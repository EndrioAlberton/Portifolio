import autoAvaliaPng from '../assets/autoAvalia.png'
...
export const projects: Project[] = [
  {
    ...
    tag: 'Projeto Pessoal',
    description:
      'Comparador de whey protein com ordenação por custo por 30g de proteína e monetização por afiliados do Mercado Livre.',
  ...
  },
  {
    ...
    tag: 'Iniciação Científica',
    description:
      'Desenvolvimento de sistema web que permita aos professores da Educação Básica buscar e acessar ferramentas tecnológicas digitais que possam ser utilizadas em sala de aula',
  ...
  },
  {
    ...
    tag: 'TCC',
    description:
      'Sistema que permite gerir os catálogos de múltiplas bibliotecas',
    techs: [
      'React',
      'TypeScript',
      'Node',
    ...
    documentation:
      'https://drive.google.com/file/d/1sGBZr86HmCNlsYCaR9MoRgqBfL4IW2Vl/view?usp=sharing',
  },
  {
    title: 'Sala Manager',
    tag: 'Projeto Pessoal',
    description:
      'Sistema para gerenciar salas de aulas, permitindo controle de salas e também das ocupações de cada sala.',
    techs: [
      'React',
      'TypeScript',
      'Node',
